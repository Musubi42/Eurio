...
| **Migrations** | `0009`, `0010`, `0011` écrites, **non appliquées au canonique** (encore à `0008`) | `SELECT * FROM _schema_migrations ORDER BY 1 DESC LIMIT 1` → `0008_dino_thresholds.sql` |
