...
| [`juge-et-banc/`](./juge-et-banc/README.md) | **Départager ArcFace et DINO, et pouvoir le prouver.** ✅ **TRANCHÉ le 2026-08-26 : ArcFace gagne** — 99,2 % de r@1 contre 98,1 % pour `dinov2_vitl14`, à **276× moins de paramètres** et **28× plus vite** ; indistinguable des deux gros DINO, significativement meilleur que `vits14` (`p = 0,00098`). Mesuré sur **260 frames eBay jamais vues**, 52 classes, une banque commune de 1 813 ancres, McNemar apparié. ⚠️ Deux réserves : ArcFace a été entraîné sur les crops de la banque, et la mesure porte sur 52 classes quand le produit en aura 671+. Avant ça (2026-08-25) : la fuite corpus-device↔juge coupée et chiffrée (+14,7 pts sur ce qu'elle avait vu). ⛔ Reste : l'axe **int8** jamais mesuré, la dette `provisional`, le passage à l'échelle. 👉 **Entrée : [`SUIVI-MATRICE.md`](./juge-et-banc/SUIVI-MATRICE.md)**, pas le README |
| [`juge-du-crop/`](./juge-du-crop/README.md) | **Construire le juge qui permettra de choisir une méthode de crop — pas la choisir.** Ouvert le 2026-08-27 après l'échec d'un 8e essai. 🔴 **Sept chantiers crop entre mai et août, un seul mode d'échec : chacun a atteint sa cible sur son PROPRE oracle et produit des crops que l'humain jette.** `crop-recovery` avait des critères pré-enregistrés et validés PO — son seuil `IoU ≥ 0,80` **tolérait 10,6 % d'amputation du rayon**. `quality_score` est mesuré **inerte** (0,9200 accepté / 0,9208 rejeté-crop). Le juge devient donc deux **contraintes dures** + un taux d'amputation, et il se **falsifie avant de servir** (RE-4). ⚠️ Ne remets **aucun score d'embedding** dans la boucle de cadrage : l'optimum y est structurellement l'amputation. Décision : [ADR-017](../adr/017-le-crop-d-enrichissement-est-decouple-du-scan.md). 👉 **Entrée : [`README.md`](./juge-du-crop/README.md)** |
...
| `juge-du-crop/` | [`README.md`](./juge-du-crop/README.md) | PROBLEME.md · JUGE.md · JEU-D-OR.md · PROTOCOLE-BANC.md · DECISIONS.md · SUIVI.md |
